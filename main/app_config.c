...
#define CFG_MAGIC     0x454D5301u        /* 'EMS' + versión 01 — invalida blobs viejos   */

/* Valores por defecto si NVS está vacío (primer arranque o tras reset) */
#define DEF_GAS_ON     1800
#define DEF_GAS_OFF    1400
...
static void cfg_set_defaults(void)
{
    ...
    g_cfg.gas_on     = DEF_GAS_ON;
    g_cfg.gas_off    = DEF_GAS_OFF;
